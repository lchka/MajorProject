...
import LoadingScreen from "./src/components/loadingscreens/loadingScreen";
import SimpleLoadingScreen from "./src/components/loadingscreens/SimpleLoadingScreen";
